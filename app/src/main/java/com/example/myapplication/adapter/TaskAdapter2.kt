...
class TaskAdapter2(
...
) : RecyclerView.Adapter<TaskAdapter2.ViewHolder>() {

    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {

        val taskName = itemView.findViewById<TextView>(R.id.txtTaskName)
        val taskAssignedTo = itemView.findViewById<TextView>(R.id.txtAssignedTo)
    ...
    override fun onBindViewHolder(
        ...
        holder.taskAssignedTo.text = item.assignedTo
