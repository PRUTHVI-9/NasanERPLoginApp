...
@AndroidEntryPoint
class PendingRoutineActivity : AppCompatActivity() {

    lateinit var binding:  ActivityPendingRoutineBinding
    lateinit var viewModel: PendingRoutineViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityPendingRoutineBinding.inflate(layoutInflater)
        ...
        viewModel = ViewModelProvider(this)[PendingRoutineViewModel::class]
        ...
        if (empId != "0") {
            ...
            viewModel.fetchPendingRoutines(empId)
        }
