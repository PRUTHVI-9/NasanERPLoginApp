...
class EmployeeViewModel @Inject constructor(
    ...
    val employeeResult = MutableLiveData<UiState<SelectEmployeeResponse>>()

    fun fetchEmployeeList() {
        employeeResult.value = UiState.Loading
        viewModelScope.launch {
            employeeResult.value = repository.fetchEmployeeList()
        }
    }
